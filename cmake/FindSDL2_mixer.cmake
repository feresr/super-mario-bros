...
#find_path(SDL2_MIXER_INCLUDE_DIR SDL_mixer.h PATH_SUFFIXES SDL2 include/SDL2 include)
...
#set(CMAKE_LD_FLAGS "${CMAKE_C_FLAGS} -m32 -arch i386")
...
#
### SDL2_mixer intrinsic dependencies
#find_library(modplugLIB modplug PATH_SUFFIXES lib ${VC_LIB_PATH_SUFFIX})
#find_library(vorbisLIB vorbis PATH_SUFFIXES lib ${VC_LIB_PATH_SUFFIX})
#find_library(oggLIB ogg PATH_SUFFIXES lib ${VC_LIB_PATH_SUFFIX})
#
#set(SDL2_MIXER ${SDL2_MIXER_LIBRARY} ${oggLIB} ${vorbisLIB} ${modplugLIB} )
