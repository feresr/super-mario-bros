...
public:
    ...
    Entity() : components{new std::unordered_map<std::type_index, Engine::Component*>()} {};
...
private:
    std::unordered_map<std::type_index, Engine::Component*>* components;
};
...
public:
    ...
    template<typename... Components>
    //TODO: Avoid allocating an entire vector, return iterators instead?
